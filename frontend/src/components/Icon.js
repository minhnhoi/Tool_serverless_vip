// Minimal inline SVG icon set so we don't add a runtime dependency.
// Usage: <Icon name="dashboard" /> or <Icon name="dashboard" size={18} />
const PATHS = {
  ...
  eyeOff:    <><path d="M17.94 17.94A10.94 10.94 0 0 1 12 20c-7 0-11-8-11-8a19.79 19.79 0 0 1 4.22-5.31"/><path d="M9.9 4.24A10.94 10.94 0 0 1 12 4c7 0 11 8 11 8a19.83 19.83 0 0 1-3.17 4.13"/><line x1="1" y1="1" x2="23" y2="23"/></>,
